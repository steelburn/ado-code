...
- **Two-sided chat layout**: AI answers render on the left; your messages appear on the right as a compact button-colored bubble that hugs its content (avatar on the right edge) — standard chat grammar, so who said what reads at a glance
