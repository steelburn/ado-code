...
- **Chat splits into two sides**: AI answers stay on the left; your messages move to the right as a compact bubble — button-colored, hugging its content (capped at 85% of the panel) with the “You” avatar on the right edge — so who said what reads at a glance
